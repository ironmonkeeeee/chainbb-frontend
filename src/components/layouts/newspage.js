      ...
      <Grid>
        <Grid.Row>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="General" feed="eos-general" imageSize="small" titleSize="ui header tiny" max={3} />
          </Grid.Column>
        ...
        <Grid.Row>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="Support" feed="eos-help" titleSize="ui header tiny" max={3} />
          </Grid.Column>
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <Section1 title="EOS governance" feed="eos-gov" titleSize="ui header tiny" max={3} />
          </Grid.Column>
        </Grid.Row>

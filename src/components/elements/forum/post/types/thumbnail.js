...
export default class ForumPostThumbnail extends React.Component {
  render() {
    let { forum, topic } = this.props;
    let moderatorRemoved = (topic._removedFrom && topic._removedFrom.indexOf(forum['_id']) >= 0);
    // let control = (
    //     (moderatorRemoved)
    //     ? <Icon name='trash' />
    ...
    //   );
        // ,
        // paginator = false,
    // let last_reply = (<Grid.Column mobile={6} tablet={6} computer={5} largeScreen={4} textAlign="center">No Replies</Grid.Column>);

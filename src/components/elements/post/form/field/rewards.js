        ...
        <Grid.Row>
          ...
          <Grid.Column width={8}>
            <Segment>
              ...
              <Header>
                <Header.Subheader>
                  The author recieves a total of 60% after all is calculated. 25% of the total is allocated to Curators by the Steem blockchain, as well as {forum_percent}% to the forum itself and {chainbb_percent}% to eostalk.
                </Header.Subheader>
                <Header.Subheader>
                  <small>
                    <strong>*</strong>
                    {' '}
                    Represents the actual percentage after the eostalk beneficiary, but before curation.
                  </small>
                </Header.Subheader>
              </Header>
            </Segment>
